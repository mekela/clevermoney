...
import restList from './scenes/restList/restList';
...
export default class router extends Component {
	render() {
		return (
			<Router >
				<Scene key="root">
					<Scene key="loginScene" component={loginScene} title="loginScene"  hideNavBar = {true}/>
					...
					<Scene key="restList" component={restList} title="restList" initial hideNavBar = {false}/>
				</Scene>
			</Router>
		)
	}
