...
export const ToasterView = (props) =>{
	...
	return <View style={{position:'absolute', width: '100%',paddingTop:20}}>
			...
			{props.message.map(message => <View style={{backgroundColor:'rgba(255,0,0,0.3)',marginTop:2, paddingVertical: 10, width: '100%', paddingHorizontal: 5}}><Text>{message}</Text></View>)}
